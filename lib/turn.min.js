...
a,_sc=this.data().f.opts.turn.get(0).getBoundingClientRect().width/this.data().f.opts.turn.width()||1;return i._cornerActivated.call(this,{x:(a.pageX-b.left)/_sc,y:(a.pageY-b.top)/_sc})},_c:function(a,b){b=b||0;switch(a){case "tl":return j(b,b);case "tr":return j(this.width()-b,b);case "bl":return j(b,this.height()-b);case "br":return j(this.width()-b,this.height()-b);case "l":return j(b,0);case "r":return j(this.width()-b,0)}},_c2:function(a){switch(a){case "tl":return j(2*this.width(),0);case "tr":return j(-this.width(),0);case "bl":return j(2*this.width(),this.height());case "br":return j(-this.width(),
